...
router.get("/admin/users", verifyJWT, authorizeRole("admin"), async (req, res): Promise<void> => {
...
router.put("/admin/users/:userId/role", verifyJWT, authorizeRole("admin"), async (req, res): Promise<void> => {
