  ...
  const handleAssign = (complaintId: number, staffIdStr: string) => {
    ...
    assignMutation.mutate(
      { id: complaintId, data: { staffId } },
      {
        ...
        onError: () => toast({ title: "Failed to assign complaint", variant: "destructive" }),
      },
    );
  };
